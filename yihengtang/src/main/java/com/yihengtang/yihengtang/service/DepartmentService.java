...
public class DepartmentService {
	...
	public Map<String,List<Experts>> departmentMap(){
		Map<String,List<Experts>> map = new HashMap<String, List<Experts>>();
		...
		for (DepartmentAndNumber departmentAndNumber : departmentName) {
			String name = departmentAndNumber.getDepartment();
			List<Experts> experts = expertsMapper.expertsClassify(name);
			map.put(name, experts);
		}
		//移除map中的value空值 
		removeNullValue(map);
